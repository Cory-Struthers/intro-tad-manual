...
#knitr::opts_knit$set(root.dir = "/Users/amberboydstun/Dropbox/text-as-data-JUST-CORY-AND-AMBER/modules/data")
```

## Lab objectives

* Get (re)familiar with R
...
#setwd("/Users/amberboydstun/Dropbox/text-as-data-JUST-CORY-AND-AMBER/modules/data")
...
# Load data
tweet_data = read.csv("~/Dropbox/text-as-data-JUST-CORY-AND-AMBER/modules/data/sample_immigration_tweets_2013-2017.csv")
#tweet_data = read.csv("/Users/amberboydstun/Dropbox/text-as-data-JUST-CORY-AND-AMBER/modules/data/sample_immigration_tweets_2013-2017.csv")
class(tweet_data)
...
**Question 1. Work with your partner or team to develop a variable of interest and a brief codebook. What was the process like? What were the easy parts, and what were the challenges?** 

**Question 2. Then subset the immigration twitter data to the same 20 observations, and each code those 20 tweets independently. What was the process like? How confident did you feel in your coding, and what did you observe from spending time with the text?**
...
View(tweet_data_coded)

# Output your data for manual coding (writing into your current working directory folder)
write.csv(tweet_data_coded, "~/Dropbox/text-as-data-JUST-CORY-AND-AMBER/modules/data/tweet_data_coded.csv", row.names=TRUE)

```

**Question 3. Calculate your inter-coder reliability (follow Professor Freelon's instructions about how to format the .csv file!). What factors help explain how high or low it is? Which particular observations did you code differently, and how might you update the coding process to improve the inter-coder reliability?**

**Question 4. Finally, discuss: what worked and what didn't, and why?**
